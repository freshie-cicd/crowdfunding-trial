...
@section('content')
    <div class="card  justify-content-center  ms-5">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('administrator.storeRoutingNums') }}" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div>
                            <div class="flex">
                                <input id="routing_number" type="text" class="form-control" name="routing_number" required>
                            </div>
                        </div>
                ...
                <div class="row mb-3 " id="bank_div">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="bank" type="text" class="form-control" name="bank" required value="">
                ...
                <div class="row mb-3 " id="branch_div">
                    ...
                    <div class="col-md-6">
                        <input id="branch" type="text" class="form-control" name="branch" required value="">
                ...
                <div class="row mb-3 " id="district_div">
                    ...
                    <div class="col-md-6">
                        <input id="district" type="text" class="form-control" name="district" required value="">
