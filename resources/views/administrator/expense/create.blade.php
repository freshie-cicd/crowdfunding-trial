                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('expense.store') }}" enctype="multipart/form-data">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4">
                              <input id="submitted_by" type="text" class="form-control @error('submitted_by') is-invalid @enderror" name="submitted_by" value="{{ old('submitted_by') }}" required autocomplete="submitted_by" autofocus>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4">
                              <input id="memo" type="text" class="form-control @error('memo') is-invalid @enderror" name="memo" value="{{ old('memo') }}" required autocomplete="memo" autofocus>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4">
                              <input id="approved_by" type="text" class="form-control @error('approved_by') is-invalid @enderror" name="approved_by" value="{{ old('approved_by') }}" required autocomplete="approved_by" autofocus>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4">
                              <select id="asset_id" type="text" class="select2 form-control @error('asset_id') is-invalid @enderror" name="asset_id" value="{{ old('asset_id') }}"  autocomplete="asset_id">
                                  <option value="">Please Select</option>
                              </select>
                              @error('asset_id')
                                  <span class="invalid-feedback" role="alert">
