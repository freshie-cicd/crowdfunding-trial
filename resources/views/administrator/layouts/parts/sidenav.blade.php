        ...
        <ul>
          ...
          <li class="menu-item">
            <a href="{{ route('package.index') }}">
              <span class="menu-icon"><i class="fa-solid fa-calendar-day"></i></span><span class="menu-title">Packages</span>
            </a>
          </li>
          ...
          <li class="menu-item sub-menu {{request()->is('administrator/payment/approved') || request()->is('administrator/payment/pending') ? 'open' : ''}}">
            <a href="#">
              <span class="menu-icon"><i class="fa-solid fa-money-bill-transfer"></i></span><span class="menu-title">Payment Proof</span>
            </a>
              ...
              <ul>
                <li class="menu-item">
                  <a href="{{ route('admin.payment.approved') }}">
                    <!-- icon checkmark -->
                    <span class="menu-icon"><i class="fa-solid fa-check"></i></span><span class="menu-title">All Approved
                    </span>
                  </a>
                </li>
                <li class="menu-item"><a href="{{ route('admin.payment.index') }}"><span class="menu-icon"><i class="fa-solid fa-clock"></i></span><span class="menu-title">Pending Approvals</span></a></li>
              </ul>
            </div>
            <!--Sub Menu Ends-->
          </li>
