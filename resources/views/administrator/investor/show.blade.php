                        ...
                        <form action="{{ route('admin.investor.profile.update') }}" method="get">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="permanent_address"
                                    name="permanent_address" value="{{ $user->permanent_address }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="present_address">Present Address</label>
                                <input type="text" class="form-control" id="present_address" name="present_address"
                                    value="{{ $user->present_address }}" readonly>
                            </div>
                            ...
                            <div class="flex flex-row justify-between">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nominee_phone"
                                        name="nominee_phone" value="{{ $user->nominee_phone }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nominee_nid">Nominee NID</label>
                                    <input type="text" class="form-control" id="nominee_nid" name="nominee_nid"
                                        value="{{ $user->nominee_nid }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nominee_address"
                                    name="nominee_address" value="{{ $user->nominee_address }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="status">Status</label>
                                <select type="text" class="form-select form-control" id="status"
                                    name="status">
                                    ...
                                    <option value="verification_pending"
                                        {{ $user->status == 'verification_pending' ? 'selected' : '' }}>Verification
                                        Pending</option>
                                    <option value="suspecious" {{ $user->status == 'suspecious' ? 'selected' : '' }}>
                                        Suspecious</option>
                                </select>
                            </div>
                            <div class="form-group">
            ...
            <div class="grow p-4 bg-white shadow-md rounded-md">
                <div class="flex flex-row">
                    <div class="grow">
                        ...
                        @if (!empty($bankDetails->checkbook_url))
                        <p class="mt-3">Cheque Image:</p>
                        <img src="{{ asset('storage/' . $bankDetails->checkbook_url) }}"
                            alt="Checkbook Image">
                        @endif
        ...
        <div class="col-span-2 mt-2">
            <div class="grow p-4 bg-white shadow-md rounded-md">
                <div class="flex flex-row">
                    ...
                    <div class="flex items-center space-x-2 px-2">
                        <a href="{{ route('administrator.booking.create', ['investor_id' => $user->id]) }}"
                            class="btn btn-danger">Create Booking</a>
                    </div>
                </div>
