              ...
              <div class="card mb-2 mt-2" style="">
                ...
                <div class="card-body">
                  ...
                  <div class="d-grid gap-2">
                        <a href="{{ url('profile/edit') }}" type="button" class="btn btn-success @if($is_profile_complete) disabled @endif"> Complete Profile</button>
                        <a href="{{ url('agreement') }}/{{ $booking->id }}/download/" class="btn btn-primary @if(!$is_profile_complete) disabled @endif">Download Instant Agreement Paper</a>
                  
                        <a href="{{ url('agreement/hard-copy/request') }}/{{ $booking->id }}/" class="btn btn-warning @if(!$is_profile_complete) disabled @endif">Request Hard Copy <br>Agreement Paper</a>
                  </div>
