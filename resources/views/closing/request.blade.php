...
<div class="card">
    ...
    <hr>
            ...
            <div class="row mb-3">
              <label for="reinvest" class="col-md-4 col-form-label text-md-end">{{ __('Do you want to reinvest the captial in Batch 6?') }}</label>
  
              <div class="col-md-6">
                  <select id="reinvest" type="text" class="form-select form-control @error('reinvest') is-invalid @enderror" name="reinvest" value="" >
