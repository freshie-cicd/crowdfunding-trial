                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mt-5">
                        ...
                        <form method="POST" action="{{ route('book.store') }}">
                            ...
                            <div class="row mb-3">
                                <label for="package"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Package') }}</label>

                                <div class="col-md-6">
                                    <input id="package" type="text"
                                        class="form-control @error('package') is-invalid @enderror" name="package"
                                        value="{{ $data[0]->name }}({{ $data[0]->code }})" required autocomplete="package"
                                        disabled>
                            ...
                            <div class="row mb-3">
                                <label for="amount"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Total Due') }}</label>

                                <div class="col-md-6">
                                    <input id="amount" type="text"
                                        class="form-control @error('amount') is-invalid @enderror" name="amount"
                                        value="{{ $data[0]->value }}" required autocomplete="amount" disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="note" type="text"
                                        ...
                                        value="" autocomplete="package" autofocus>
