    ...
    public function download($booking_id)
        {
            ...
            $booking_info = Booking::where('bookings.id', $booking_id)
                            ...
                            ->select('bookings.booking_quantity', 'packages.value','packages.note', 'bookings.code', 'project_batches.ending_date', 'bookings.code', 'booking_payments.payment_date', 'project_batches.project_id')
                            ->get();
