                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <center> <img
                                                            src="{{ asset('storage/' . config('website-setting.dark_logo')) }}"
                                                            style="margin-top: 24px; height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; border-style: none; border-width: 0;">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                                                    ...
                                                                                    <h5 class="text-teal-700"
                                                                                        ...
                                                                                        align="left">Please follow the
                                                                                        steps bellow to complete the
                                                                                        payment.</h5>
                                                                                    ...
                                                                                    <p class="text-gray-700"
                                                                                        ...
                                                                                        It may take up to 2 Working days
                                                                                        to confirm the payment receiving
                                                                                        and activation.
                                                                                    ...
                                                                                    <p class="text-gray-700"
                                                                                        ...
                                                                                        visit https://freshie.farm or
                                                                                        call us on +880-1776-505359
