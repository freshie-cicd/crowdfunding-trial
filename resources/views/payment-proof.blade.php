...
<form method="POST" action="{{ route('paymentProofStore') }}" enctype="multipart/form-data">
    ...
    <div class="row mb-3">
        <label for="payment_date" class="col-md-4 col-form-label text-md-end">{{ __('When did you deposit?') }}</label>
    ...
    <div class="row mb-3">
        <label for="file" class="col-md-4 col-form-label text-md-end">{{ __('Verification Document') }}</label>
    ...
    <div class="row mb-3">
        <label for="depositors_name" class="col-md-4 col-form-label text-md-end">{{ __('Depositors Name') }}</label>
    ...
    <div class="row mb-3">
        <label for="depositors_mobile_number" class="col-md-4 col-form-label text-md-end">{{ __('Depositors Mobile Number') }}</label>
    ...
    <div class="row mb-3">
        <label for="deposit_reference" class="col-md-4 col-form-label text-md-end">{{ __('Deposit Reference') }}</label>
