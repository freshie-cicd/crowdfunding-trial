...
@section('content')
    <div class="card">
        ...
        <div class="card-header">My Profile
            ...
            <a href="{{ url('profile/edit') }}" class="btn btn-sm btn-primary float-end">Edit Profile</a>
            <a href="{{ url('/profile/change_password') }}" class="btn btn-sm btn-primary float-end">Change Password</a>
                ...
                <tbody>
                    ...
                    @foreach ($user_data as $data)
                        ...
                        <tr>
                            ...
                            <th scope="row">Permament Address</th>
