...
<div class="">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <select class="form-control form-select" name='shortlist' id="shortlist" onchange='updateFilter()'>
                                ...
                                <option value='1' {{ request()->shortlist == 1 ? 'selected' : '' }}>Short List for Bank</option>
            ...
            <div class="card">
                <div class="card-header">{{ __('Closing Bank Sheet') }}</div>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered table-hover table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope="row">'{{ $info->routing_number }}</th>
                                <th scope="row">{{ $info->capital_withdrawal_amount + $info->profit_withdrawal_amount }}</th>
                                <th scope="row">{{ __('32') }}</th>
                                <th scope="row">{{ __('PPD') }}</th>
                                <th scope="row">{{ __('0') }}</th>
                                <th scope="row">{{ __('Mark as Processed Btn') }}</th>
                            </tr>
                            @endforeach
                        </tbody>
...
<script>
    function updateFilter() {
        ...
        url.searchParams.delete('shortlist', shortlist);
        }
