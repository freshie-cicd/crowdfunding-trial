...
<div class="">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Profit Return Report') }}</div>
                ...
                <div class="card-body">
                    ...
                    <table id="dataTable" class="table table-striped table-bordered table-hover table-responsive">
                        ...
                        <tbody>
                            ...
                            @php
                            $total_profit = $total_profit + $d->profit_withdrawal_amount;
...
<script>
    ...
    new DataTable('#dataTable', {
        ...
        buttons: [{
                extend: 'excelHtml5',
                title: 'Freshie_Profit_Return' + currentDate,
                footer: true
            },
            {
                extend: 'pdf',
