                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.investor.store_password') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="full_name" type="text" class="form-control @error('password') is-invalid @enderror" name="user_full_name" value="{{ $data[0]->name }}"  autocomplete="password" disabled>
